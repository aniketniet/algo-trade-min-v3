...
const DashboardNavbar = () => {
  ...
  return (
    <div>
      ...
      <dialog id="passport-change-dialog" className="rounded-lg p-0 w-full max-w-md">
        <div className="flex items-center justify-between border-b border-gray-200 bg-gray-50 px-6 py-4">
          <h3 className="text-lg font-semibold text-gray-800">Change Passport</h3>
          <button
            type="button"
        ...
        <form method="dialog" className="bg-white p-6 rounded-lg shadow-lg">
          ...
          />
          <label className="text-md text-gray-600 mb-2">Confirm New Passport</label>
          <input
            type="password"
            className="mb-4 w-full border border-gray-300 rounded-md p-2 text-sm text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
